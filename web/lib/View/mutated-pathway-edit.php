...
$steps = $mutated_pathway->getStepsAsArray();
$processes = $mutated_pathway->getMitochondrialProcessesAsArray();
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        <header>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/search?q=*&filter_type[]=mutated_pathway">Deregulated pathways</a></li>
                    <li class="breadcrumb-item"><a href="/pathway/<?= $mutated_pathway->getName() ?>"><?= $mutated_pathway->getName() ?></a></li>
        ...
        <main class="container">
            <h2>
                <?= $mutated_pathway->getName() ?>
                <small class="text-muted">: edit</small>
            </h2>
            
            <form id="pathway-edit-form" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="put">
                <input type="hidden" name="type" value="mutated_pathway">
                <input type="hidden" name="name" value="<?= str_replace(['/', '+'], ['---0', '---1'], $mutated_pathway->getName()) ?>">
                
                <div class="form-group row">
                    <label for="pathway-edit-form-name" class="col-sm-2 col-form-label">Name</label>
                    <div class="col-sm-10">
                        <input type="text" name="name" id="pathway-edit-form-name" class="form-control" value="<?= $mutated_pathway->getName() ?>" disabled="disabled">
                        <small class="form-text text-muted">Name of this deregulated pathway, cannot be changed.</small>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="contributor" id="pathway-edit-form-contributor" class="form-control" value="<?= $mutated_pathway->getContributor() ?>">
                        <small class="form-text text-muted">Contributor of this pathway.</small>
                    </div>
                </div>
                
                <div class="form-group row">
                    <label for="pathway-edit-form-original" class="col-sm-2 col-form-label">Original pathway</label>
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" value="<?= $mutated_pathway->getOriginalPathway()->getName() ?>" class="form-control ajax-search" id="pathway-edit-form-original-search" data-target="#pathway-edit-form-original" data-filter="type:pathway" placeholder="Type original pathway name here...">
                            </div>
                            <div class="col-sm-6">
                                <select name="original_pathway" class="form-control" id="pathway-edit-form-original">
                                    <option value="<?= $mutated_pathway->getOriginalPathway()->getName() ?>"><?= $mutated_pathway->getOriginalPathway()->getName() ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                        <input type="text" name="theorem_body" value="<?= expression_to_string($mutated_pathway->getTheorem()->getBody()) ?>" class="form-control mitopaths-expression" placeholder="Theorem body">
                        <small class="form-text text-muted">
                    ...
                    <div class="col-sm-5">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="theorem_head" value="<?= expression_to_string($mutated_pathway->getTheorem()->getHead()) ?>" class="form-control mitopaths-expression" placeholder="Theorem head">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        ...
                        <small class="form-text text-muted">
                            List of mitochondrial processes this deregulated pathway is involved in. <strong>If the mitochondrial process you are looking for does not appear while typing, you will have to create it before proceeding.</strong>
                        </small>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea name="attributes[information]" class="form-control"><?= $mutated_pathway->getAttribute('information');  ?></textarea>
