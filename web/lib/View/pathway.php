...
<html lang="en">
    <head>
        ...
        <?php $this->view('head'); ?>
        <link href="/public/css/vis-network.min.css" rel="stylesheet" type="text/css" />
        <style>
    ...
    <body>
        ...
        <main class="container pathway-page">
            <h2>
                ...
                <a href="/pathway/<?= str_replace(['/', '+'], ['---0', '---1'], $pathway->getName()) ?>/edit" class="btn btn-primary btn-sm float-right" title="Edit or delete this pathway">Edit</a>
                <?php endif; ?>
            </h2>
            <small class="text-muted">Contributor: <?= $pathway->getContributor() ?></small>
            ...
            <section class="card mb-3">
                <h3 class="card-header">Mito-location</h3>
                <div class="card-body row">
                    <div class="col-sm-4">
                        <div class="list-group">
                            <div class="list-group-item mitolocation-na">
                                <h5 class="mb-1">Not Available/Not Relevant</h5>
                    ...
                    <div class="col-sm-8">
                        <div class="list-group">
                            <div class="list-group-item mitolocation-m">
                                <img src="/public/icons/dot/00001.svg" alt="M" class="small-icon img-fluid">
                                <h5 class="mb-1">Matrix</h5>
                                <ul class="list-inline"></ul>
                            </div>
                            
                            <div class="list-group-item mitolocation-im">
                                <img src="/public/icons/dot/00010.svg" alt="IM" class="small-icon img-fluid">
                                <h5 class="mb-1">Inner Membrane</h5>
                                <ul class="list-inline"></ul>
                            </div>
                            
                            <div class="list-group-item mitolocation-ims">
                                <img src="/public/icons/dot/00100.svg" alt="IMS" class="small-icon img-fluid">
                                <h5 class="mb-1">Inter-Membrane Space</h5>
                                <ul class="list-inline"></ul>
                            </div>
                            
                            <div class="list-group-item mitolocation-om">
                                <img src="/public/icons/dot/01000.svg" alt="OM" class="small-icon img-fluid">
                                <h5 class="mb-1">Outer Membrane</h5>
                                <ul class="list-inline"></ul>
                            </div>
                            
                            <div class="list-group-item mitolocation-pms">
                                <img src="/public/icons/dot/10000.svg" alt="PMS" class="small-icon img-fluid">
                                <h5 class="mb-1">Peri-Mitochondrial Space</h5>
                                <ul class="list-inline"></ul>
                            </div>
                        </div>
                    </div>
...
-->
                ...
                <div class="card-body row">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" style="margin: auto" data-interval="false">
...
<!--
                    <div class="col-sm-4">
                        <div class="list-group">
                            <div class="list-group-item dynamic-mitolocation-na">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-8">
                        <div class="list-group">
                            <div class="list-group-item dynamic-mitolocation" style="height: 400px">
                            </div>
                        </div>
                    </div>
-->
