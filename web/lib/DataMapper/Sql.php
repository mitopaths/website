...
trait Sql {
    ...
    protected function getConnection() {
        ...
        self::$dbh = new \PDO(
            'mysql:host=' . $config['database_backoffice']['host'] . ';dbname=' . $config['database_backoffice']['name'] . ';charset=utf8', 
            $config['database_backoffice']['user'],
            $config['database_backoffice']['password']
        );
